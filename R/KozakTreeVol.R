...
#'
#' # If applied to number of trees, and accounting for expansion factor.
#'
#' tempvol <- mapply(KozakTreeVol, 'ib', data.frame$SPP, data.frame$DBH, data.frame$HT)
#' data.frame$vol <- tempvol * data.frame$EXPF
#'
#' @export
